...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
      <path fill="#4285F4" d="M45.1 24.5c0-1.6-.1-3.1-.4-4.6H24v9h11.8c-.5 2.7-2 5-4.3 6.5v5.4h7C42.5 37 45.1 31.3 45.1 24.5z" />
      ...
      <path fill="#FBBC05" d="M11.6 28.3c-.4-1.3-.7-2.7-.7-4.3s.2-2.9.7-4.3v-5.6H4.3C2.8 17.1 2 20.5 2 24s.8 6.9 2.3 9.9l7.3-5.6z" />
      <path fill="#EA4335" d="M24 10.7c3.2 0 6.1 1.1 8.4 3.3l6.2-6.2C34.9 4.2 29.9 2 24 2 15.3 2 7.9 7 4.3 14.1l7.3 5.6c1.7-5.2 6.6-9 12.4-9z" />
    </svg>
  );
}
