...
describe('EmptyState', () => {
  it('renders the title and description', () => {
    render(<EmptyState icon={<span>icon</span>} title="No organizations yet" description="Create one to get started." />);
  ...
  it('renders the action when provided', () => {
    render(<EmptyState icon={<span>icon</span>} title="No plans yet" action={<button>+ Add plan</button>} />);
