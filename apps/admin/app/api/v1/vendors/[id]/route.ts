    ...
    return NextResponse.json(
      {
        error: {
          ...
          message: safeErrorMessage(
            error,
            'Could not load this vendor. Please try again, or contact support if this continues.',
            `vendors.fetch(${id})`,
          ),
        },
      },
    ...
    return NextResponse.json(
      {
        error: {
          ...
          message: safeErrorMessage(
            error,
            'Could not update this vendor. Please try again, or contact support if this continues.',
            `vendors.update(${id})`,
          ),
        },
      },
